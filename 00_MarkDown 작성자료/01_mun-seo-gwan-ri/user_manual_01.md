...
!!! Tip "수신문서 일괄처리 기능"
    ...
    - **일괄담당자과제지정** : 수신문서의 업무관리자(마지막결재자)로 지정된 경우 업무담당자를 일괄 지정

??? Info "결재진행중 문서의 결재경로 변경"
    문서제목 선택 후 상단의 결재경로 버튼을 클릭하거나, 결재정보 탭의 결재경로 항목에서 결재경로지정 버튼을 클릭하여 변경 가능. 다만 결재대기에서 문서를 처리하는 사용자가 **협조자**인 경우 결재경로 변경 불가
...
!!! Info "공람 완료된 문서의 삭제"
    사용자가 공람 확인을 완료한 문서는 일반적인 방법으로는 삭제할 수 없습니다. 다만, **시도총괄관리자** 또는 **지역총괄관리자** 권한을 가진 사용자가 **문서등록대장** 하단의 **공람정보** 탭에서 삭제 버튼을 통해 해당 공람 내역을 삭제할 수 있습니다. 삭제 시 해당 사용자의 공람완료함에서 문서가 제거되어 더 이상 열람할 수 없게 됩니다.
...
문서등록대장에 등록된 문서는 결재가 완료되었거나 접수되어 문서번호가 채번된 문서이며, 기록물 이관 대상으로 관리되므로 삭제할 수 없습니다.
