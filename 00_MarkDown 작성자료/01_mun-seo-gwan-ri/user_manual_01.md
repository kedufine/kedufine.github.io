...
=== "결재정보 탭"
    ...
    * 문서정보
        ...
        문서정보에서는 문서의 기본적인 메타데이터를 입력할 수 있습니다. 제목, 과제카드, 대국민공개여부, 공개제한근거는 필수 입력 항목이며, 제목에는 개인정보가 포함되지 않도록 주의해야 합니다.
        ...
        !!! Warning "직원열람제한 관련 제약사항"
            ...
            - 보안공유 지정 권한 : 총괄관리자, 기록물담당자, 결재선(기안자/업무담당자), 과제카드 관리자, 감사담당자(감사담당자관리 메뉴에 등록된 사용자)
