...
=== "업무편람 탭"
    ...
    *   **업무자료**
		...
		과제카드 수행에 필요한 각종 업무 관련 자료를 등록하고 관리하는 기능입니다. 사용자가 먼저 **'자료유형관리'** 버튼을 통해 '선진사례'와 같은 자료의 유형을 직접 등록한 후, 해당 유형에 맞는 업무 자료를 추가할 수 있습니다.
...
*   **과제카드 인수 절차**
	...
	1.  **인수 목록 조회**: 먼저 인수할 과제카드 목록을 조회합니다. 이때 과제카드명을 클릭하면 인계 정보(인계 요청 사유 등)를 확인할 수 있습니다.
