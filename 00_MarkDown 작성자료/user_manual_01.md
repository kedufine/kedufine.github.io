...
결재대기에서는 상신된 결재문서를 처리할 수 있습니다. 각 문서를 선택하면 문서관리카드 내에서 단건결재, 연속결재 (1) , 일괄결재 (2) 로 결재를 할 수 있습니다. 결재 방법은 아래와 같습니다.
{ .annotate }
...
1.  :man_raising_hand: 일괄접수 처리 관련 안내
	- 다건 문서 선택 후 일괄접수 처리
		- 접수 : 선택된 문서들의 접수 처리
...
어붐담당확인 함에서는 처리과문서담당자가 업무담당확인 요청한 문서를 확인할 수 있으며 담당확인 또는 재확인요청 처리 할 수 있습니다.
